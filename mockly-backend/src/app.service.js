...
const { categories, types, options } = require('./app.config');

/**
 * @typedef {Object} Category
 * @property {string} id - The id of the category.
 * @property {string} name - The name of the category.
 * @property {string} code - The unique code for the category.

 * @typedef {Object} Type
 * @property {string} id - The id of the type.
 * @property {string} name - The name of the type.
 * @property {string} code - The unique code for the type.
 */
...
const createObject = (items) => {
  return () => {
    return items.reduce((acc, { category, field, type }) => {
